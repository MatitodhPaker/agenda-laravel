...
class ContactosController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $contacto->save();
        return redirect()->route('contactos.index')->with('success','1');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $contacto->email=$request->post('correo');
        $contacto->save();
        return redirect()->route('contactos.index')->with('success','2');
    }
    ...
    public function destroy($id)
    {
        $contacto = Contactos::find($id);
        $contacto->delete();
        return redirect()->route('contactos.index')->with('success','3');
    }
}
